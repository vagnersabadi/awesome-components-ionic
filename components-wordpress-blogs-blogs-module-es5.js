...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-wordpress-blogs-blogs-module"], {
  ...
  /***/
  function srcAppPagesSamplesComponentsWordpressBlogsBlogpageBlogpageModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BlogpagePageModule", function () {
      return BlogpagePageModule;
    });
    /* harmony import */
    ...
    var _blogpage_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./blogpage.page */
    "./src/app/pages/samples/components/wordpress/blogs/blogpage/blogpage.page.ts");

    var BlogpagePageModule = function BlogpagePageModule() {
      _classCallCheck(this, BlogpagePageModule);
    };

    BlogpagePageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: BlogpagePageModule
    });
    BlogpagePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function BlogpagePageModule_Factory(t) {
        return new (t || BlogpagePageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BlogpagePageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlogpagePageModule, [{
  ...
  /***/
  function srcAppPagesSamplesComponentsWordpressBlogsBlogpageBlogpagePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BlogpagePage", function () {
      return BlogpagePage;
    });
    /* harmony import */
    ...
    var src_app_services_wordpress_wordpress_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    function BlogpagePage_ion_img_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "ion-img", 12);
      }

      if (rf & 2) {
        var ctx_r370 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("src", ctx_r370.image_url);
      }
    }

    function BlogpagePage_ion_grid_12_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var ctx_r371 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    ...
    function BlogpagePage_ion_row_13_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var ctx_r372 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    ...
    function BlogpagePage_ion_chip_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BlogpagePage_ion_grid_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "ion-grid");
    ...
    var BlogpagePage = /*#__PURE__*/function () {
      function BlogpagePage(activatedRoute, wp_service, modaCtrl) {
      ...
      _createClass(BlogpagePage, [{
        ...
        value: function ngOnInit() {
          ...
          this.wp_service.getBlogDetail(this.id).subscribe(function (result) {
            _this.blogDetail = result;

            _this.getImage(_this.blogDetail);
        ...
        value: function getImage(data) {
          ...
          this.wp_service.getImage(data.featured_media).subscribe(function (data) {
            _this2.blogDetail.imageData = data;
            _this2.image_url = _this2.blogDetail.imageData.source_url;
          });
        }
      }, {
        key: "getTags",
        value: function getTags() {
          ...
          this.wp_service.getTags().subscribe(function (data) {
            _this3.blogDetail.tagsData = data.filter(function (item) {
              return _this3.blogDetail.tags.includes(item.id);
            });
            console.log(_this3.blogDetail);
          });
        }
      }, {
        key: "getAuthor",
        value: function getAuthor() {
          ...
          this.wp_service.getUser(this.blogDetail.author).subscribe(function (data) {
            console.log(data);
            _this4.blogDetail.authorData = data;
          });
        }
      }, {
        key: "dismiss",
    ...
    BlogpagePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      template: function BlogpagePage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function BlogpagePage_Template_ion_button_click_5_listener() {
            return ctx.dismiss();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](BlogpagePage, [{
        ...
        return [{
          ...
          type: src_app_services_wordpress_wordpress_service__WEBPACK_IMPORTED_MODULE_1__["WordpressService"]
        }, {
  ...
  /***/
  function srcAppPagesSamplesComponentsWordpressBlogsBlogsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _blogs_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./blogs.page */
    "./src/app/pages/samples/components/wordpress/blogs/blogs.page.ts");
    /* harmony import */


    var _blogpage_blogpage_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./blogpage/blogpage.module */
    "./src/app/pages/samples/components/wordpress/blogs/blogpage/blogpage.module.ts");
    ...
    BlogsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: BlogsPageModule
    });
    BlogsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function BlogsPageModule_Factory(t) {
        return new (t || BlogsPageModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _blogpage_blogpage_module__WEBPACK_IMPORTED_MODULE_6__["BlogpagePageModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BlogsPageModule, {
        declarations: [_blogs_page__WEBPACK_IMPORTED_MODULE_5__["BlogsPage"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _blogpage_blogpage_module__WEBPACK_IMPORTED_MODULE_6__["BlogpagePageModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlogsPageModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _blogpage_blogpage_module__WEBPACK_IMPORTED_MODULE_6__["BlogpagePageModule"]],
          declarations: [_blogs_page__WEBPACK_IMPORTED_MODULE_5__["BlogsPage"]]
  ...
  /***/
  function srcAppPagesSamplesComponentsWordpressBlogsBlogsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_wordpress_wordpress_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./../../../../../services/wordpress/wordpress.service */
    "./src/app/services/wordpress/wordpress.service.ts");
    /* harmony import */
    ...
    var _blogpage_blogpage_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    function BlogsPage_div_9_Template(rf, ctx) {
      if (rf & 1) {
        var _r379 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 5);

        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function BlogsPage_div_9_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r379);

          var item_r377 = ctx.$implicit;

          var ctx_r378 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();
    ...
    var BlogsPage = /*#__PURE__*/function () {
      function BlogsPage(wp_service, modalCtrl) {
      ...
      _createClass(BlogsPage, [{
        ...
        value: function getBlogData() {
          ...
          this.wp_service.getBlogs().subscribe(function (result) {
            _this5.blogPosts = result;
        ...
        value: function getImages() {
          ...
          this.wp_service.getMedia().subscribe(function (data) {
            _this6.blogPosts.forEach(function (element) {
              var media = data.filter(function (item) {
                return item.id === element.featured_media;
              });
              element.imageData = media[0];
            });

            console.log(_this6.blogPosts);
          });
        }
      }, {
        key: "openBlog",
        value: function openBlog(id) {
    ...
    BlogsPage.ɵfac = function BlogsPage_Factory(t) {
      return new (t || BlogsPage)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_services_wordpress_wordpress_service__WEBPACK_IMPORTED_MODULE_2__["WordpressService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]));
    };

    BlogsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      type: BlogsPage,
      selectors: [["app-blogs"]],
      decls: 10,
      vars: 1,
      consts: [["color", "primary"], ["slot", "start"], ["defaultHref", "/samples"], ["color", "primary", 1, "ion-text-center"], ["class", "video-list ion-no-padding", "mode", "md", 3, "click", 4, "ngFor", "ngForOf"], ["mode", "md", 1, "video-list", "ion-no-padding", 3, "click"], [1, "imagediv", 3, "ngStyle"], [1, "details"], [1, "title-block"], [1, "title"], [1, "extra"], [1, "views"]],
      template: function BlogsPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](BlogsPage, [{
        ...
        return [{
          type: _services_wordpress_wordpress_service__WEBPACK_IMPORTED_MODULE_2__["WordpressService"]
        }, {
  ...
  function srcAppServicesWordpressWordpressServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      */
      ...
      _createClass(WordpressService, [{
        ...
        value: function getBlogs() {
          return this.http.get("".concat(this.url, "/wp/v2/posts")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            return results;
          }));
          ;
        }
        ...
        */
        ...
        key: "getBlogDetail",
        value: function getBlogDetail(id) {
          return this.http.get("".concat(this.url, "/wp/v2/posts/").concat(id));
        }
        /**
        ...
        */
        ...
        value: function getMedia() {
          return this.http.get("".concat(this.url, "/wp/v2/media"));
        }
        /**
        ...
        */
        ...
        value: function getImage(id) {
          console.log('id', id);
          return this.http.get("".concat(this.url, "/wp/v2/media/").concat(id));
        }
        /**
        ...
        */
        ...
        key: "getTags",
        value: function getTags() {
          return this.http.get("".concat(this.url, "/wp/v2/tags"));
        }
        /**
        ...
        */
        ...
        value: function getUser(id) {
          return this.http.get("".concat(this.url, "/wp/v2/users/").concat(id));
        }
      }]);
    ...
    WordpressService.ɵfac = function WordpressService_Factory(t) {
      return new (t || WordpressService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
...
//# sourceMappingURL=components-wordpress-blogs-blogs-module-es5.js.map