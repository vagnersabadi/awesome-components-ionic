    ...
    */
      ...
      _createClass(RippleRenderer, [{
        ...
        value: function fadeInRipple(x, y) {
          ...
          */
          function () {
            /** @type {?} */
            var isMostRecentTransientRipple = rippleRef === _this12._mostRecentTransientRipple;
            rippleRef.state = 1
            /* VISIBLE */
            ...
            if (!config.persistent && (!isMostRecentTransientRipple || !_this12._isPointerDown)) {
              rippleRef.fadeOut();
            }
          }, duration);
          ...
          */
          function () {
            ...
            */
            function (type) {
              /** @type {?} */
              _this13._triggerElement.addEventListener(type, _this13, passiveEventOptions);
            });
          });
        }
        /**
        ...
        value: function _removeTriggerEvents() {
          ...
          if (this._triggerElement) {
            ...
            */
            function (type) {
              /** @type {?} */
              _this14._triggerElement.removeEventListener(type, _this14, passiveEventOptions);
            });
    ...
    var MatOptgroup = /*#__PURE__*/function (_MatOptgroupMixinBase2) {
      ...
      function MatOptgroup() {
        ...
        _this15._labelId = "mat-optgroup-label-".concat(_uniqueOptgroupIdCounter++);
        return _this15;
      }
