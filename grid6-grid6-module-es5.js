...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["grid6-grid6-module"], {
  ...
  /***/
  function srcAppPagesSamplesComponentsGridsGrid6Grid6RoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Grid6PageRoutingModule", function () {
      return Grid6PageRoutingModule;
    });
    /* harmony import */
    ...
    var _grid6_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./grid6.page */
    ...
    var Grid6PageRoutingModule = function Grid6PageRoutingModule() {
      _classCallCheck(this, Grid6PageRoutingModule);
    };

    Grid6PageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: Grid6PageRoutingModule
    });
    Grid6PageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function Grid6PageRoutingModule_Factory(t) {
        return new (t || Grid6PageRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](Grid6PageRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Grid6PageRoutingModule, [{
  ...
  /***/
  function srcAppPagesSamplesComponentsGridsGrid6Grid6ModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Grid6PageModule", function () {
      return Grid6PageModule;
    });
    /* harmony import */
    ...
    var _grid6_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./grid6-routing.module */
    "./src/app/pages/samples/components/grids/grid6/grid6-routing.module.ts");
    /* harmony import */


    var _grid6_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./grid6.page */
    "./src/app/pages/samples/components/grids/grid6/grid6.page.ts");

    var Grid6PageModule = function Grid6PageModule() {
      _classCallCheck(this, Grid6PageModule);
    };

    Grid6PageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: Grid6PageModule
    });
    Grid6PageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function Grid6PageModule_Factory(t) {
        return new (t || Grid6PageModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _grid6_routing_module__WEBPACK_IMPORTED_MODULE_4__["Grid6PageRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](Grid6PageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Grid6PageModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _grid6_routing_module__WEBPACK_IMPORTED_MODULE_4__["Grid6PageRoutingModule"]],
          declarations: [_grid6_page__WEBPACK_IMPORTED_MODULE_5__["Grid6Page"]]
  ...
  /***/
  function srcAppPagesSamplesComponentsGridsGrid6Grid6PageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Grid6Page", function () {
      return Grid6Page;
    });
    /* harmony import */
    ...
    function Grid6Page_ion_col_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var Grid6Page = /*#__PURE__*/function () {
      function Grid6Page(gridServ) {
        _classCallCheck(this, Grid6Page);

        this.gridServ = gridServ;
        this.medicines = this.gridServ.medicines;
      }

      _createClass(Grid6Page, [{
        key: "ngOnInit",
    ...
    Grid6Page.ɵfac = function Grid6Page_Factory(t) {
      return new (t || Grid6Page)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_grid_grid_service_service__WEBPACK_IMPORTED_MODULE_0__["GridServiceService"]));
    };

    Grid6Page.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: Grid6Page,
      selectors: [["app-grid6"]],
      decls: 9,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/grids"], [1, "title-ios"], ["margin-top", "", "margin-bottom", ""], ["size", "4", 4, "ngFor", "ngForOf"], ["size", "4"], ["margin-top", "", 1, "cardSection"], [3, "src"], [1, "contentText"]],
      template: function Grid6Page_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](Grid6Page, [{
...
//# sourceMappingURL=grid6-grid6-module-es5.js.map