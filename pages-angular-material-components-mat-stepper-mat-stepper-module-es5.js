    ...
    var MatIconRegistry = /*#__PURE__*/function () {
      ...
      _createClass(MatIconRegistry, [{
        ...
        value: function _getSvgFromIconSetConfigs(name, iconSetConfigs) {
          ...
          */
          function (iconSetConfig) {
            return _this3._loadSvgIconSetFromConfig(iconSetConfig).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(
            /**
            * @param {?} err
            * @return {?}
            */
    ...
    */
    ...
    var MatIcon = /*#__PURE__*/function (_MatIconMixinBase2) {
      ...
      function MatIcon(elementRef, _iconRegistry, ariaHidden, _location, _errorHandler) {
        ...
        _this7._inline = false;
        /**
         * Subscription to the current in-progress SVG icon request.
         */

        _this7._currentIconFetch = rxjs__WEBPACK_IMPORTED_MODULE_4__["Subscription"].EMPTY; // If the user has not explicitly set aria-hidden, mark the icon as hidden, as this is
