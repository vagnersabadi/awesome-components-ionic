  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SelectJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatSelect = /*#__PURE__*/function (_MatSelectMixinBase2) {
      ...
      function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, defaults) {
        ...
        _this21 = _super13.call(this, elementRef, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
        _this21._viewportRuler = _viewportRuler;
        _this21._changeDetectorRef = _changeDetectorRef;
        _this21._ngZone = _ngZone;
        _this21._dir = _dir;
        _this21._parentFormField = _parentFormField;
        _this21.ngControl = ngControl;
        _this21._liveAnnouncer = _liveAnnouncer;
        /**
         * Whether or not the overlay panel is open.
         */

        _this21._panelOpen = false;
        /**
         * Whether filling out the select is required in the form.
         */

        _this21._required = false;
        /**
         * The scroll position of the overlay panel, calculated to center the selected option.
         */

        _this21._scrollTop = 0;
        /**
         * Whether the component is in multiple selection mode.
         */

        _this21._multiple = false;
        /**
         * Comparison function to specify which option is displayed. Defaults to object equality.
         */

        _this21._compareWith =
        /**
        * @param {?} o1
        * @param {?} o2
        * @return {?}
        */
        ...
        _this21._uid = "mat-select-".concat(nextUniqueId++);
        /**
         * Emits whenever the component is destroyed.
         */

        _this21._destroy = new rxjs__WEBPACK_IMPORTED_MODULE_12__["Subject"]();
        /**
         * The cached font-size of the trigger element.
         */

        _this21._triggerFontSize = 0;
        /**
        ...
        */
        ...
        _this21._transformOrigin = 'top';
        /**
         * Emits when the panel element is finished transforming in.
         */

        _this21._panelDoneAnimatingStream = new rxjs__WEBPACK_IMPORTED_MODULE_12__["Subject"]();
        /**
        ...
        _this21._disableOptionCentering = false;
        _this21._focused = false;
        /**
         * A name for this control that can be used by `mat-form-field`.
         */

        _this21.controlType = 'mat-select';
        /**
        ...
        _this21.optionSelectionChanges =
        /** @type {?} */
        ...
        */
        function () {
          ...
          return _this21._ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["switchMap"])(
          /**
          * @return {?}
          */
          function () {
            return _this21.optionSelectionChanges;
          }));
        });
        /**
        ...
        _this21.openedChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
         * Event emitted when the select has been opened.
         */

        _this21._openedStream = _this21.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
        ...
        */
        ...
        _this21._closedStream = _this21.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
        ...
        */
        ...
        _this21.selectionChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
        ...
        _this21.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();

        if (_this21.ngControl) {
          // Note: we provide the value accessor through here, instead of
          // the `providers` to avoid running into a circular import.
          _this21.ngControl.valueAccessor = _assertThisInitialized(_this21);
        }

        _this21._scrollStrategyFactory = scrollStrategyFactory;
        _this21._scrollStrategy = _this21._scrollStrategyFactory();
        _this21.tabIndex = parseInt(tabIndex) || 0; // Force setter to be called in case id was not specified.

        _this21.id = _this21.id;

        if (defaults) {
          if (defaults.disableOptionCentering != null) {
            _this21.disableOptionCentering = defaults.disableOptionCentering;
          }

          if (defaults.typeaheadDebounceInterval != null) {
            _this21.typeaheadDebounceInterval = defaults.typeaheadDebounceInterval;
          }
        }
      ...
      _createClass(MatSelect, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            if (_this22.panelOpen) {
              _this22._scrollTop = 0;

              _this22.openedChange.emit(true);
            } else {
              _this22.openedChange.emit(false);

              _this22.overlayDir.offsetX = 0;
          ...
          */
          function () {
            if (_this22._panelOpen) {
              _this22._triggerRect = _this22.trigger.nativeElement.getBoundingClientRect();
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function () {
            _this23._resetOptions();

            _this23._initializeSelection();
          });
        }
        /**
         * @return {?}
        ...
        value: function open() {
          ...
          */
          function () {
            if (_this24._triggerFontSize && _this24.overlayDir.overlayRef && _this24.overlayDir.overlayRef.overlayElement) {
              _this24.overlayDir.overlayRef.overlayElement.style.fontSize = "".concat(_this24._triggerFontSize, "px");
            }
          });
        }
        /**
        ...
        value: function _onAttached() {
          ...
          */
          function () {
            _this25._changeDetectorRef.detectChanges();

            _this25._calculateOverlayOffsetX();

            _this25.panel.nativeElement.scrollTop = _this25._scrollTop;
          });
        }
        /**
        ...
        value: function _initializeSelection() {
          ...
          */
          function () {
            _this26._setSelectionByValue(_this26.ngControl ? _this26.ngControl.value : _this26._value);
          ...
          if (this.multiple && value) {
            ...
            */
            function (currentValue) {
              return _this27._selectValue(currentValue);
            });
          ...
          */
          function (option) {
            try {
              ...
              return option.value != null && _this28._compareWith(option.value, value);
            } catch (error) {
        ...
        value: function _initKeyManager() {
          ...
          */
          function () {
            if (_this29.panelOpen) {
              ...
              if (!_this29.multiple && _this29._keyManager.activeItem) {
                _this29._keyManager.activeItem._selectViaInteraction();
          ...
          */
          function () {
            if (_this29._panelOpen && _this29.panel) {
              _this29._scrollActiveOptionIntoView();
            } else if (!_this29._panelOpen && !_this29.multiple && _this29._keyManager.activeItem) {
              _this29._keyManager.activeItem._selectViaInteraction();
            }
          });
        }
        ...
        value: function _resetOptions() {
          ...
          */
          function (event) {
            _this30._onSelect(event.source, event.isUserInput);

            if (event.isUserInput && !_this30.multiple && _this30._panelOpen) {
              _this30.close();
        ...
        value: function _sortValues() {
          ...
          if (this.multiple) {
            ...
            */
            function (a, b) {
              return _this31.sortComparator ? _this31.sortComparator(a, b, options) : options.indexOf(a) - options.indexOf(b);
            });
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TableJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatTable = /*#__PURE__*/function (_angular_cdk_table__W) {
      ...
      function MatTable() {
        ...
        _this32 = _super14.apply(this, arguments);
        /**
         * Overrides the sticky CSS class set by the `CdkTable`.
         */

        _this32.stickyCssClass = 'mat-table-sticky';
        return _this32;
      }
    ...
    var MatHeaderCell = /*#__PURE__*/function (_angular_cdk_table__W6) {
      ...
      function MatHeaderCell(columnDef, elementRef) {
        ...
        _this33 = _super19.call(this, columnDef, elementRef);
    ...
    var MatFooterCell = /*#__PURE__*/function (_angular_cdk_table__W7) {
      ...
      function MatFooterCell(columnDef, elementRef) {
        ...
        _this34 = _super20.call(this, columnDef, elementRef);
        elementRef.nativeElement.classList.add("mat-column-".concat(columnDef.cssClassFriendlyName));
        return _this34;
      }
    ...
    var MatCell = /*#__PURE__*/function (_angular_cdk_table__W8) {
      ...
      function MatCell(columnDef, elementRef) {
        ...
        _this35 = _super21.call(this, columnDef, elementRef);
        elementRef.nativeElement.classList.add("mat-column-".concat(columnDef.cssClassFriendlyName));
        return _this35;
      }
    ...
    var MatTableDataSource = /*#__PURE__*/function (_angular_cdk_table__W16) {
      ...
      function MatTableDataSource() {
        ...
        _this36._renderData = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
        /**
         * Stream that emits when a new filter string is set on the data source.
         */

        _this36._filter = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]('');
        /**
         * Used to react to internal changes of the paginator that are made by the data source itself.
         */

        _this36._internalPageChanges = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Subscription to the changes that should trigger an update to the table's rendered rows, such
         * as filtering, sorting, pagination, or base data changes.
         */

        _this36._renderChangesSubscription = rxjs__WEBPACK_IMPORTED_MODULE_4__["Subscription"].EMPTY;
        /**
        ...
        */
        function (data, sort) {
          ...
          */
          function (a, b) {
            /** @type {?} */
            var valueA = _this36.sortingDataAccessor(a, active);
            /** @type {?} */


            var valueB = _this36.sortingDataAccessor(b, active); // If both valueA and valueB exist (truthy), then compare the two. Otherwise, check if
        ...
        */
        ...
        _this36._data = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](initialData);

        _this36._updateChangeSubscription();
      ...
      _createClass(MatTableDataSource, [{
        ...
        value: function _updateChangeSubscription() {
          ...
          */
          function (_ref) {
            ...
            return _this37._filterData(data);
          ...
          */
          function (_ref3) {
            ...
            return _this37._orderData(data);
          ...
          */
          function (data) {
            return _this37._renderData.next(data);
          });
        }
        /**
        ...
        value: function _filterData(data) {
          ...
          */
          function (obj) {
            return _this38.filterPredicate(obj, _this38.filter);
          });
        ...
        value: function _updatePaginator(filteredDataLength) {
          ...
          */
          function () {
            /** @type {?} */
            var paginator = _this39.paginator;
            ...
            if (paginator.pageIndex > 0) {
              ...
              if (newPageIndex !== paginator.pageIndex) {
                ...
                _this39._internalPageChanges.next();
              }
            }
          });
        }
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TooltipJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatTooltip = /*#__PURE__*/function () {
      ...
      _hammerLoader) {
        ...
        */
        function (event) {
          if (_this40._isTooltipVisible() && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event)) {
            event.preventDefault();
        ...
        */
        function () {
          _elementRef.nativeElement.addEventListener('keydown', _this40._handleKeydown);
        });
      }
      /**
      ...
      _createClass(MatTooltip, [{
        ...
        value: function _createOverlay() {
          ...
          */
          function (change) {
            if (_this42._tooltipInstance) {
              if (change.scrollableViewProperties.isOverlayClipped && _this42._tooltipInstance.isVisible()) {
        ...
        value: function _updateTooltipMessage() {
          ...
          if (this._tooltipInstance) {
            ...
            */
            function () {
              if (_this43._tooltipInstance) {
                /** @type {?} */
                _this43._overlayRef.updatePosition();
              }
            });
          }
        }
        ...
        value: function _setupPointerEvents() {
          ...
          if (!this._platform.IOS && !this._platform.ANDROID) {
            ...
            */
            function touchendListener() {
              clearTimeout(_this44._touchstartTimeout);

              _this44.hide(_this44._defaultOptions.touchendHideDelay);
            };
            ...
            */
            function () {
              ...
              clearTimeout(_this44._touchstartTimeout);
              _this44._touchstartTimeout = setTimeout(
              /**
              * @return {?}
              */
              function () {
          ...
          */
          function (listener, event) {
            _this44._elementRef.nativeElement.addEventListener(event, listener, passiveListenerOptions);
          });
        }
        /**
          ...
          if (!this._message && this._isTooltipVisible()) {
            ...
            */
            function () {
              ...
              */
              function () {
                _this45._ariaDescriber.describe(_this45._elementRef.nativeElement, _this45.message);
              });
            });
          }
        }
    ...
    var TooltipComponent = /*#__PURE__*/function () {
      ...
      _createClass(TooltipComponent, [{
        ...
        value: function show(delay) {
          ...
          */
          function () {
            _this46._visibility = 'visible';
            _this46._showTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways

            _this46._markForCheck();
          }, delay);
        }
        /**
        ...
        value: function hide(delay) {
          ...
          */
          function () {
            _this47._visibility = 'hidden';
            _this47._hideTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways

            _this47._markForCheck();
          }, delay);
        }
        /**
  ...
  function srcAppPagesAngularMaterialComponentsMatTableMatTablePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatTablePage_td_10_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", user_r8.first_name, " ");
      }
    }
    ...
    function MatTablePage_td_13_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", user_r9.last_name, " ");
      }
    }
    ...
    function MatTablePage_td_16_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", user_r10.twitter, " ");
      }
    }
    ...
    MatTablePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["table[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
