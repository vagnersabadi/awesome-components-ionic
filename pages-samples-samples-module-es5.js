...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-samples-samples-module"], {
  ...
  function srcAppPagesSamplesSamplesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | components-gestures-gestures-module */
        "components-gestures-gestures-module").then(__webpack_require__.bind(null,
        /*! ./components/gestures/gestures.module */
        "./src/app/pages/samples/components/gestures/gestures.module.ts")).then(function (m) {
          return m.GesturesPageModule;
        });
      }
    }];
