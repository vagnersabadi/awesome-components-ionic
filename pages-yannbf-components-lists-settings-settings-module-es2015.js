...
/* harmony import */ var _settings_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./settings.page */ "./src/app/pages/yannbf/components/lists/settings/settings.page.ts");
...
SettingsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SettingsPage, selectors: [["app-settings"]], decls: 79, vars: 0, consts: [["slot", "start"], ["defaultHref", "/"], ["name", "airplane", "slot", "start", "color", "danger"], ["color", "secondary", "slot", "end"], ["name", "wifi", "slot", "start", "color", "primary"], ["slot", "end"], ["name", "bluetooth", "slot", "start", "color", "primary"], ["name", "call", "slot", "start", "color", "secondary"], ["name", "link", "slot", "start", "color", "secondary"], ["value", "always"], ["value", "always", "slot", "end"], ["value", "locked", "slot", "end"], ["name", "logo-ionic", "slot", "start", "color", "primary"], ["fill", "outline", "slot", "end"], ["name", "brush", "slot", "start", "color", "primary"], ["name", "logo-octocat", "slot", "start", "color", "dark"], ["name", "paw", "slot", "start", "color", "danger"]], template: function SettingsPage_Template(rf, ctx) { if (rf & 1) {
