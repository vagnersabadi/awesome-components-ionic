...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-lists-users-users-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsListsUsersUsersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _users_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./users.page */
  ...
  /***/
  function srcAppPagesYannbfComponentsListsUsersUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _users_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./users.page */
    "./src/app/pages/yannbf/components/lists/users/users.page.ts");
    ...
    UsersPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_4__["UsersPageRoutingModule"]]]
    });
  ...
  /***/
  function srcAppPagesYannbfComponentsListsUsersUsersPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function UsersPage_ion_item_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    UsersPage.ɵfac = function UsersPage_Factory(t) {
      return new (t || UsersPage)();
    };

    UsersPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: UsersPage,
      selectors: [["app-users"]],
      decls: 9,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/"], [1, "ion-padding"], ["lines", "none"], [4, "ngFor", "ngForOf"], ["src", "assets/yannbf/img/avatar/ian-avatar.png"], [1, "rating"], ["icon", "md-star"], ["fill", "clear", "slot", "end"], ["slot", "end", 1, "number-circle"]],
...
//# sourceMappingURL=pages-yannbf-components-lists-users-users-module-es5.js.map