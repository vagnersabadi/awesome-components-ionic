...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-login-login-background-video-login-background-video-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsLoginLoginBackgroundVideoLoginBackgroundVideoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginBackgroundVideoPageModule", function () {
    ...
    var _login_background_video_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./login-background-video.page */
    ...
    var LoginBackgroundVideoPageModule = function LoginBackgroundVideoPageModule() {
      _classCallCheck(this, LoginBackgroundVideoPageModule);
    };

    LoginBackgroundVideoPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: LoginBackgroundVideoPageModule
    });
    LoginBackgroundVideoPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function LoginBackgroundVideoPageModule_Factory(t) {
        return new (t || LoginBackgroundVideoPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LoginBackgroundVideoPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginBackgroundVideoPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsLoginLoginBackgroundVideoLoginBackgroundVideoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginBackgroundVideoPage", function () {
    ...
    var LoginBackgroundVideoPage = /*#__PURE__*/function () {
      function LoginBackgroundVideoPage() {
        _classCallCheck(this, LoginBackgroundVideoPage);
      }

      _createClass(LoginBackgroundVideoPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // It's interesting to remove the src and put it back
    ...
    LoginBackgroundVideoPage.ɵfac = function LoginBackgroundVideoPage_Factory(t) {
      return new (t || LoginBackgroundVideoPage)();
    };

    LoginBackgroundVideoPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: LoginBackgroundVideoPage,
      selectors: [["app-login-background-video"]],
      viewQuery: function LoginBackgroundVideoPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 17,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/"], [1, "ion-padding", "ion-text-center", 3, "fullscreen"], ["src", "assets/yannbf/img/logo/logo-canon.png", 1, "logo"], [1, "buttons"], [1, "login-button", "facebook", 3, "click"], [1, "login-button", "google", 3, "click"], ["color", "dark", 1, "login-button", 3, "click"], ["playsinline", "", "autoplay", "", "muted", "", "loop", "", "poster", "assets/yannbf/video/video-cover.jpg", "id", "bgvid"], ["player", ""], ["src", "assets/yannbf/video/background-480.mp4", "type", "video/mp4"]],
      template: function LoginBackgroundVideoPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginBackgroundVideoPage_Template_ion_button_click_7_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginBackgroundVideoPage_Template_ion_button_click_9_listener() {
            return ctx.goToLogin();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginBackgroundVideoPage_Template_ion_button_click_11_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginBackgroundVideoPage, [{
