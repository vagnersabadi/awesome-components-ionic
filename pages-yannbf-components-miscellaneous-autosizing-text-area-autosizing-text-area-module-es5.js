...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-miscellaneous-autosizing-text-area-autosizing-text-area-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousAutosizingTextAreaAutosizingTextAreaModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AutosizingTextAreaPageModule", function () {
    ...
    var _autosizing_text_area_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./autosizing-text-area.page */
    ...
    var AutosizingTextAreaPageModule = function AutosizingTextAreaPageModule() {
      _classCallCheck(this, AutosizingTextAreaPageModule);
    };

    AutosizingTextAreaPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: AutosizingTextAreaPageModule
    });
    AutosizingTextAreaPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function AutosizingTextAreaPageModule_Factory(t) {
        return new (t || AutosizingTextAreaPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AutosizingTextAreaPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AutosizingTextAreaPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousAutosizingTextAreaAutosizingTextAreaPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AutosizingTextAreaPage", function () {
    ...
    var AutosizingTextAreaPage = /*#__PURE__*/function () {
      function AutosizingTextAreaPage() {
        _classCallCheck(this, AutosizingTextAreaPage);
      ...
      _createClass(AutosizingTextAreaPage, [{
        key: "ngOnInit",
    ...
    AutosizingTextAreaPage.ɵfac = function AutosizingTextAreaPage_Factory(t) {
      return new (t || AutosizingTextAreaPage)();
    };

    AutosizingTextAreaPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AutosizingTextAreaPage,
      selectors: [["app-autosizing-text-area"]],
      decls: 26,
      vars: 4,
      consts: [["slot", "start"], ["defaultHref", "/"], [3, "value"], ["placeholder", "Enter more information here..."], ["position", "floating"], ["position", "stacked"], ["disabled", "", "readonly", "", 3, "value"], ["clearOnEdit", "true", 3, "value"], ["rows", "6", "cols", "20", "placeholder", "Enter any notes here..."]],
      template: function AutosizingTextAreaPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AutosizingTextAreaPage, [{
