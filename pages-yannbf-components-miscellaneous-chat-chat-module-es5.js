...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-miscellaneous-chat-chat-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousChatChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _messages_messages_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    ...
    ChatPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: ChatPageModule
    });
    ChatPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function ChatPageModule_Factory(t) {
        return new (t || ChatPageModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _messages_messages_module__WEBPACK_IMPORTED_MODULE_0__["MessagesPageModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ChatPageModule, {
        declarations: [_chat_page__WEBPACK_IMPORTED_MODULE_6__["ChatPage"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _messages_messages_module__WEBPACK_IMPORTED_MODULE_0__["MessagesPageModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ChatPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousChatChatPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _messages_messages_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function ChatPage_ion_item_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChatPage_ion_item_11_Template_ion_item_click_0_listener() {
          ...
          return ctx_r148.viewMessages(chat_r147);
        });
    ...
    var ChatPage = /*#__PURE__*/function () {
      ...
      _createClass(ChatPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //  Open modal messages

      }, {
        key: "viewMessages",
        value: function viewMessages(chat) {
    ...
    ChatPage.ɵfac = function ChatPage_Factory(t) {
      return new (t || ChatPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]));
    };
    ...
    ChatPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 60,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/"], [1, "chats"], [3, "click", 4, "ngFor", "ngForOf"], ["src", "assets/yannbf/img/avatar/marty-avatar.png"], ["slot", "end"], [3, "click"], [3, "src"]],
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousChatMessagesMessagesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _messages_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./messages.page */
    "./src/app/pages/yannbf/components/miscellaneous/chat/messages/messages.page.ts");
    ...
    MessagesPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: MessagesPageModule
    });
    MessagesPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function MessagesPageModule_Factory(t) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MessagesPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MessagesPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousChatMessagesMessagesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function MessagesPage_div_8_div_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var message_r141 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function MessagesPage_div_8_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function MessagesPage_div_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    MessagesPage.ɵfac = function MessagesPage_Factory(t) {
      return new (t || MessagesPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]));
    };

    MessagesPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MessagesPage,
      selectors: [["app-messages"]],
      viewQuery: function MessagesPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 15,
      vars: 4,
      consts: [["slot", "start"], ["slot", "icon-only", "fill", "clear", 3, "click"], ["name", "arrow-back"], ["class", "message-wrapper", 4, "ngFor", "ngForOf"], ["novalidate", "", 3, "formGroup", "submit"], ["formControlName", "message", 3, "ngModel", "placeholder", "ngModelChange"], ["fill", "clear", "slot", "end", 3, "click"], ["name", "send", 1, "footer-btn"], [1, "message-wrapper"], [4, "ngIf"], [1, "cf"], ["onerror", "onProfilePicError(this)", 1, "profile-pic", "left", 3, "src"], [1, "chat-bubble", "left", "slide-left"], ["autolinker", "", 1, "message", 3, "innerHTML"], [1, "message-detail"], [1, "bold"], ["onerror", "onProfilePicError(this)", 1, "profile-pic", "right", 3, "src"], [1, "chat-bubble", "right", "slide-right"]],
      template: function MessagesPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MessagesPage_Template_ion_button_click_3_listener() {
            return ctx.close();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function MessagesPage_Template_form_submit_10_listener() {
            return ctx.send(ctx.chatBox);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function MessagesPage_Template_ion_input_ngModelChange_12_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MessagesPage_Template_ion_button_click_13_listener() {
            return ctx.send(ctx.chatBox);
          });
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["LowerCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MessagesPage, [{
