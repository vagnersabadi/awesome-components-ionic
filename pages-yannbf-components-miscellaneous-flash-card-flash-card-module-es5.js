...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-miscellaneous-flash-card-flash-card-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousFlashCardFlashCardModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FlashCardPageModule", function () {
    ...
    var _flash_card_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./flash-card.page */
    ...
    var FlashCardPageModule = function FlashCardPageModule() {
      _classCallCheck(this, FlashCardPageModule);
    };

    FlashCardPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: FlashCardPageModule
    });
    FlashCardPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function FlashCardPageModule_Factory(t) {
        return new (t || FlashCardPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FlashCardPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FlashCardPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsMiscellaneousFlashCardFlashCardPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FlashCardPage", function () {
    ...
    var _components_yannbf_flash_card_flash_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../../../../components/yannbf/flash-card/flash-card.component */
    "./src/app/components/yannbf/flash-card/flash-card.component.ts");

    function FlashCardPage_app_flash_card_component_7_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var card_r156 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("src", card_r156.front.image, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](card_r156.front.subtitle);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](card_r156.front.title);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", card_r156.front.content, " ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](card_r156.back.subtitle);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](card_r156.back.title);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", card_r156.back.content, " ");
      }
    }

    var FlashCardPage = /*#__PURE__*/function () {
      function FlashCardPage() {
        ...
        this.flashCards = [{
          front: {
            image: 'assets/yannbf/img/flashcards/namaste.jpg',
            title: 'Namaste',
            subtitle: 'नमस्ते'
          },
          back: {
    ...
    FlashCardPage.ɵfac = function FlashCardPage_Factory(t) {
      return new (t || FlashCardPage)();
    };

    FlashCardPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FlashCardPage,
      selectors: [["app-flash-card"]],
      decls: 8,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/"], [4, "ngFor", "ngForOf"], [1, "fc-front"], [3, "src"], [1, "fc-back"]],
      template: function FlashCardPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FlashCardPage, [{
...
//# sourceMappingURL=pages-yannbf-components-miscellaneous-flash-card-flash-card-module-es5.js.map