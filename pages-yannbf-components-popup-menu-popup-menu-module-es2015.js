...
let PopupMenuOnePageModule = class PopupMenuOnePageModule {
};
...
let PopupMenuOnePage = class PopupMenuOnePage {
...
PopupMenuOnePage.ctorParameters = () => [
...
let PopupMenuTwoPageModule = class PopupMenuTwoPageModule {
};
...
let PopupMenuTwoPage = class PopupMenuTwoPage {
    constructor(modalCtrl) {
        this.modalCtrl = modalCtrl;
        this.openMenu = false;
    }
...
PopupMenuTwoPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
