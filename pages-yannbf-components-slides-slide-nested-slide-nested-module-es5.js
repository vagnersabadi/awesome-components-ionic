...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-slides-slide-nested-slide-nested-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideNestedSlideNestedModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideNestedPageModule", function () {
    ...
    var _slide_nested_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./slide-nested.page */
    ...
    var SlideNestedPageModule = function SlideNestedPageModule() {
      _classCallCheck(this, SlideNestedPageModule);
    };

    SlideNestedPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: SlideNestedPageModule
    });
    SlideNestedPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function SlideNestedPageModule_Factory(t) {
        return new (t || SlideNestedPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SlideNestedPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideNestedPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideNestedSlideNestedPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideNestedPage", function () {
    ...
    function SlideNestedPage_ion_slide_8_ion_slide_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SlideNestedPage_ion_slide_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SlideNestedPage = /*#__PURE__*/function () {
      function SlideNestedPage() {
        _classCallCheck(this, SlideNestedPage);
    ...
    SlideNestedPage.ɵfac = function SlideNestedPage_Factory(t) {
      return new (t || SlideNestedPage)();
    };

    SlideNestedPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SlideNestedPage,
      selectors: [["app-slide-nested"]],
      decls: 9,
      vars: 1,
      consts: [["slot", "start"], ["defaultHref", "/"], ["pager", ""], [4, "ngFor", "ngForOf"], ["pager", "", 3, "options"], ["slider", ""], [3, "ngStyle", 4, "ngFor", "ngForOf"], [3, "ngStyle"]],
      template: function SlideNestedPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideNestedPage, [{
...
//# sourceMappingURL=pages-yannbf-components-slides-slide-nested-slide-nested-module-es5.js.map