...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-yannbf-components-theming-theming-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsThemingThemingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ThemingPageModule", function () {
    ...
    var _theming_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./theming.page */
    ...
    var ThemingPageModule = function ThemingPageModule() {
      _classCallCheck(this, ThemingPageModule);
    };

    ThemingPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ThemingPageModule
    });
    ThemingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ThemingPageModule_Factory(t) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ThemingPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsThemingThemingPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ThemingPage", function () {
      return ThemingPage;
    });
    /* harmony import */
    ...
    var ThemingPage = /*#__PURE__*/function () {
      function ThemingPage() {
        _classCallCheck(this, ThemingPage);
      }

      _createClass(ThemingPage, [{
        key: "ngOnInit",
    ...
    ThemingPage.ɵfac = function ThemingPage_Factory(t) {
      return new (t || ThemingPage)();
    };

    ThemingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ThemingPage,
      selectors: [["app-theming"]],
      decls: 5,
      vars: 0,
      template: function ThemingPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ThemingPage, [{
...
//# sourceMappingURL=pages-yannbf-components-theming-theming-module-es5.js.map