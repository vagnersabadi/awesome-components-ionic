...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["slide-free-mode-slide-free-mode-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideFreeModeSlideFreeModeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideFreeModePageModule", function () {
    ...
    var _slide_free_mode_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./slide-free-mode.page */
    ...
    var SlideFreeModePageModule = function SlideFreeModePageModule() {
      _classCallCheck(this, SlideFreeModePageModule);
    };

    SlideFreeModePageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: SlideFreeModePageModule
    });
    SlideFreeModePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function SlideFreeModePageModule_Factory(t) {
        return new (t || SlideFreeModePageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SlideFreeModePageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideFreeModePageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideFreeModeSlideFreeModePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideFreeModePage", function () {
    ...
    function SlideFreeModePage_ion_slide_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SlideFreeModePage = /*#__PURE__*/function () {
      function SlideFreeModePage() {
        _classCallCheck(this, SlideFreeModePage);
      ...
      _createClass(SlideFreeModePage, [{
        key: "ngOnInit",
    ...
    SlideFreeModePage.ɵfac = function SlideFreeModePage_Factory(t) {
      return new (t || SlideFreeModePage)();
    };

    SlideFreeModePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SlideFreeModePage,
      selectors: [["app-slide-free-mode"]],
      decls: 9,
      vars: 2,
      consts: [["slot", "start"], ["defaultHref", "/"], [3, "options"], [3, "ngStyle", 4, "ngFor", "ngForOf"], [3, "ngStyle"]],
      template: function SlideFreeModePage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideFreeModePage, [{
...
//# sourceMappingURL=slide-free-mode-slide-free-mode-module-es5.js.map