...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["slide-rtl-slide-rtl-module"], {
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideRtlSlideRtlModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideRtlPageModule", function () {
    ...
    var _slide_rtl_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./slide-rtl.page */
    ...
    var SlideRtlPageModule = function SlideRtlPageModule() {
      _classCallCheck(this, SlideRtlPageModule);
    };

    SlideRtlPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: SlideRtlPageModule
    });
    SlideRtlPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function SlideRtlPageModule_Factory(t) {
        return new (t || SlideRtlPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SlideRtlPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideRtlPageModule, [{
  ...
  /***/
  function srcAppPagesYannbfComponentsSlidesSlideRtlSlideRtlPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SlideRtlPage", function () {
      return SlideRtlPage;
    });
    /* harmony import */
    ...
    function SlideRtlPage_ion_slide_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SlideRtlPage = /*#__PURE__*/function () {
      function SlideRtlPage() {
        _classCallCheck(this, SlideRtlPage);
    ...
    SlideRtlPage.ɵfac = function SlideRtlPage_Factory(t) {
      return new (t || SlideRtlPage)();
    };

    SlideRtlPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SlideRtlPage,
      selectors: [["app-slide-rtl"]],
      viewQuery: function SlideRtlPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 10,
      vars: 2,
      consts: [["slot", "start"], ["defaultHref", "/"], ["pager", "", "dir", "rtl", 3, "options", "ionSlideDidChange"], ["slider", ""], [3, "ngStyle", 4, "ngFor", "ngForOf"], [3, "ngStyle"]],
      template: function SlideRtlPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionSlideDidChange", function SlideRtlPage_Template_ion_slides_ionSlideDidChange_7_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SlideRtlPage, [{
...
//# sourceMappingURL=slide-rtl-slide-rtl-module-es5.js.map